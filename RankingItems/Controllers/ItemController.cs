...
public class ItemController : ControllerBase
    {
        private static readonly IEnumerable<ItemModel> Items = new[]
        {
            ...
            new ItemModel{Id = 14, Title = "Birds in the Trap",                 ImageId=14, Ranking=0,ItemType=2 },
            new ItemModel{Id = 15, Title = "Carter III",                        ImageId=15, Ranking=0,ItemType=2 },
            new ItemModel{Id = 16, Title = "Channel Orange",                    ImageId=16, Ranking=0,ItemType=2 },
            new ItemModel{Id = 17, Title = "DAMN",                              ImageId=17, Ranking=0,ItemType=2 },
            new ItemModel{Id = 18, Title = "Life of Pablo",                     ImageId=18, Ranking=0,ItemType=2 },
            new ItemModel{Id = 19, Title = "My beautiful Dark Twisted Fantasy", ImageId=19, Ranking=0,ItemType=2 },
            new ItemModel{Id = 20, Title = "SBTRKT",                            ImageId=20, Ranking=0,ItemType=2 }
